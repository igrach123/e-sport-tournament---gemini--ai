...
const StorageManager: React.FC<StorageManagerProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="bg-gray-800 rounded-xl shadow-2xl border border-gray-700 w-full max-w-md overflow-hidden relative">
        ...
        <div className="p-6 space-y-6">
            <div className="space-y-4">
                <h4 className="text-sm uppercase tracking-wider text-gray-400 font-semibold">Backup & Restore</h4>
                <div className="grid grid-cols-2 gap-4">
                    <button 
                        onClick={handleExport}
                        className="flex flex-col items-center justify-center p-4 bg-gray-700 hover:bg-gray-600 rounded-lg border border-gray-600 transition-colors group"
                    >
                        <DownloadIcon className="w-8 h-8 mb-2 text-indigo-400 group-hover:text-indigo-300" />
                    ...
                    <button 
                        ...
                        className="flex flex-col items-center justify-center p-4 bg-gray-700 hover:bg-gray-600 rounded-lg border border-gray-600 transition-colors group"
                    >
                        <UploadIcon className="w-8 h-8 mb-2 text-emerald-400 group-hover:text-emerald-300" />
            ...
            <div className="pt-4 border-t border-gray-700">
                <h4 className="text-sm uppercase tracking-wider text-red-400 font-semibold mb-3">Danger Zone</h4>
                <button 
                    onClick={handleReset}
                    className="w-full flex items-center justify-center gap-2 p-3 bg-red-900/20 hover:bg-red-900/40 text-red-400 border border-red-900/50 rounded-lg transition-colors"
                >
